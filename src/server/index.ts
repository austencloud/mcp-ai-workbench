...
import { reasoningControllerMethods } from "./controllers/reasoningController";
...
app.post("/rpc", async (request, reply) => {
  try {
    ...
    switch (method) {
      ...
      case "getMemories":
        result = await memoryControllerMethods.searchMemories({
          query: params.query || "",
          ...params.filters,
        ...
        break;
      case "updateMemory":
        result = await memoryControllerMethods.recall({
          query: `Update memory ${params.id}`,
          maxResults: 1,
        });
        break;
      case "deleteMemory":
      ...
      case "reasoning.reason":
        result = await reasoningControllerMethods["reasoning.reason"](params);
        break;
      case "reasoning.generateTrainingData":
        result = await reasoningControllerMethods[
          "reasoning.generateTrainingData"
        ](params);
        break;
      case "reasoning.getTypes":
        result = await reasoningControllerMethods["reasoning.getTypes"]();
        break;
      case "reasoning.validateTrace":
        result = await reasoningControllerMethods["reasoning.validateTrace"](
          params
        );
        break;
      case "reasoning.getStats":
        result = await reasoningControllerMethods["reasoning.getStats"]();
        break;
      case "reasoning.startTraining":
        result = await reasoningControllerMethods["reasoning.startTraining"](
          params
        );
        break;
      case "reasoning.getTrainingStatus":
        result = await reasoningControllerMethods[
          "reasoning.getTrainingStatus"
        ](params);
        break;
      case "reasoning.exportTrainingData":
        result = await reasoningControllerMethods[
          "reasoning.exportTrainingData"
        ](params);
        break;
      default:
